...
def make_dot(var, params=None, show_attrs=False, show_saved=False, max_attr_chars=50, mask = itertools.repeat("orange")):
    ...
    def color():
        ...
        else: return 'red' if color else 'cyan'
